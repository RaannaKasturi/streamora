...
part 'details_by_language.g.dart';

class DetailsByLanguage {
  ...
  Future<List<MovieListData>> getDetailsByLanguage(
...
Future<List<MovieListData>> getDetailsByLanguage(ref,
    {required String languageISO, required String mediaType}) async {
  return await DetailsByLanguage().getDetailsByLanguage(
