...
class TopRatedMovies {
  ...
  Future<List<MovieListData>> getTopRatedSeries() async {
    final String countryCode = await tmdb.countryCode;
    final response = await dio.get(
      "$baseTMDBEndpoint/tv/top_rated?region=$countryCode",
...
Future<List<MovieListData>> topRatedSeries(ref) async {
  return await TopRatedMovies().getTopRatedSeries();
}
