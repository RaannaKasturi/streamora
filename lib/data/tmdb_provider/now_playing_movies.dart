...
class NoWPlayingMovies {
  ...
  Future<List<MovieListData>> getNowPlaying() async {
    final String countryCode = await tmdb.countryCode;
    final response = await dio.get(
      "$baseTMDBEndpoint/movie/now_playing?region=$countryCode",
...
Future<List<MovieListData>> nowPlaying(ref) async {
  return await NoWPlayingMovies().getNowPlaying();
}
